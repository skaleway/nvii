      ...
      <main className="max-w-5xl  mx-auto bg-background min-h-screen relative w-full z-[999]">
        <nav className="sticky top-0 w-full bg-background/80 backdrop-blur-md border-b border-border z-50">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg">Nvii</span>
            </div>
        ...
        <section className="pt-32 pb-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block mb-6 px-4 py-2 bg-muted/50 rounded-full text-sm font-medium">
        ...
        <section className="py-20 px-6">
          <div className="mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                { step: "1", title: "Login", desc: "Authenticate with Nvii" },
                { step: "2", title: "Create", desc: "Initialize your project" },
                {
                  step: "3",
                  title: "Collaborate",
                  desc: "Share with your team",
                },
                { step: "4", title: "Deploy", desc: "Sync across devices" },
              ].map((item, idx) => (
                <div key={idx} className="relative">
                  <div className="bg-foreground text-background w-10 h-10 rounded-full flex items-center justify-center font-bold mb-4">
                    {item.step}
                  </div>
                  <h3 className="font-bold mb-2">{item.title}</h3>
                  <p className="text-sm text-muted-foreground">{item.desc}</p>
                  <div className="hidden md:block absolute top-5 left-14 w-[calc(100%-3.5rem)] h-0.5 bg-border" />
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Join teams worldwide who trust Nvii for secure environment
              management
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
        ...
        <footer className="border-t border-border py-12 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-bold">Nvii</span>
                </div>
            ...
            <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
              <p>&copy; 2025 Nvii. All rights reserved.</p>
